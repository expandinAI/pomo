...
Lokales Backlog-System für das Pomo Projekt.
...
| ID | Titel | Status | Priority | Epic |
|----|-------|--------|----------|------|
| [POMO-001](./POMO-001-timer-core.md) | Timer component with accurate countdown | DONE | P0 | Core Timer |
| [POMO-002](./POMO-002-controls.md) | Start/Pause/Reset controls | DONE | P0 | Core Timer |
| [POMO-003](./POMO-003-session-switching.md) | Session type switching | DONE | P0 | Core Timer |
| [POMO-004](./POMO-004-audio-notification.md) | Audio notification on completion | DONE | P0 | Core Timer |
| [POMO-005](./POMO-005-tab-title.md) | Tab title update with timer state | DONE | P1 | Core Timer |
| [POMO-006](./POMO-006-keyboard-shortcuts.md) | Keyboard shortcuts | DONE | P1 | Core Timer |
| [POMO-007](./POMO-007-design-tokens.md) | Design system tokens setup | DONE | P0 | Premium Feel |
