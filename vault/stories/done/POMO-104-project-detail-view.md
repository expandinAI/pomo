...
### Navigation
- [x] **Given** ich bin in der Project List, **When** ich Enter auf einem Projekt drücke, **Then** öffnet sich der Detail View
- [x] **Given** ich bin im Detail View, **When** ich `Escape` oder Backspace drücke, **Then** gehe ich zurück zur Liste

### Header
- [x] **Given** ich bin im Detail View, **When** ich das Projekt sehe, **Then** zeigt der Header den Projektnamen
- [x] **Given** ich bin im Detail View, **When** ich `E` drücke, **Then** öffnet sich das Edit Modal

### Partikel-Visualisierung
- [x] **Given** das Projekt hat Partikel, **When** ich den View sehe, **Then** sehe ich eine visuelle Darstellung (Dots/Grid)
- [x] **Given** die Visualisierung, **When** ich sie sehe, **Then** zeigt sie die Brightness des Projekts

### Statistiken
- [x] **Given** das Projekt hat Partikel, **When** ich den View sehe, **Then** sehe ich "Total Partikel" und "Total Focus Time"
- [x] **Given** das Projekt hat Partikel, **When** ich den View sehe, **Then** sehe ich Breakdown: This Week / This Month / All Time
- [x] **Given** das Projekt hat keine Partikel, **When** ich den View sehe, **Then** zeigt es "0 Partikel" (kein Empty State)

### Session History
- [x] **Given** das Projekt hat Partikel, **When** ich den View sehe, **Then** sehe ich eine Liste der Recent Sessions
- [x] **Given** die Session-Liste, **When** ich eine Session sehe, **Then** zeigt sie Datum, Dauer und Task-Name
...
**Implementiert als Modal statt separater Route:**
- ProjectParticleViz: Dot-Grid-Visualisierung mit Brightness
- ProjectStatsCards: This Week / This Month / All Time Breakdown
- ProjectSessionList: Session-Historie gruppiert nach Datum
- ProjectDetailModal: Haupt-Detail-View mit Edit-Integration
- ProjectListModal aktualisiert: Enter öffnet Detail, Click navigiert

**Commit:** `4154bc0` - feat(projects): Add Project Detail View with stats and sessions (POMO-104)
