...
- [x] **Given** ich bin im Statistics View (`G S`), **When** ich scrolle, **Then** sehe ich einen "By Project" Section
- [x] **Given** die "By Project" Section, **When** Projekte mit Partikeln existieren, **Then** sehe ich eine Breakdown-Liste
- [x] **Given** die Breakdown-Liste, **When** ich sie sehe, **Then** zeigt jedes Projekt: Name, Partikel-Count, Prozent, Bar-Visualisierung

### Zeitraum-Filter
- [x] **Given** der Stats View zeigt "This Week", **When** ich "By Project" sehe, **Then** zeigt es nur Partikel dieser Woche
- [x] **Given** der Stats View zeigt "This Month", **When** ich "By Project" sehe, **Then** zeigt es nur Partikel dieses Monats
- [x] **Given** der Stats View zeigt "All Time", **When** ich "By Project" sehe, **Then** zeigt es alle Partikel

### Sortierung & Darstellung
- [x] **Given** mehrere Projekte, **When** ich die Liste sehe, **Then** sind sie nach Partikel-Count sortiert (highest first)
- [x] **Given** ein Projekt hat 0 Partikel im Zeitraum, **When** ich die Liste sehe, **Then** erscheint es nicht
- [x] **Given** "No Project" Partikel existieren, **When** ich die Liste sehe, **Then** erscheint "No Project" als letzter Eintrag

### Klickbarkeit
- [x] **Given** ich sehe ein Projekt in der Liste, **When** ich darauf klicke, **Then** navigiere ich zum Project Detail View
...
**Implementiert:**
- StatsProjectBreakdown Komponente mit horizontaler Bar-Visualisierung
- getProjectBreakdown erweitert für 'day' Zeitraum
- Integration in StatisticsDashboard nach Weekly Report
- Click-Handler navigiert direkt zum Project Detail View
- ProjectListModal hört auf `particle:open-project-detail` Event

**Commit:** `96325fe` - feat(stats): Add Project Breakdown to Statistics Dashboard (POMO-105)
